<div id="sidebar"
    class="fixed top-16 md:top-0 left-0 z-40 w-64 h-full bg-white border-r shadow-md transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out">
                ...
                <ul class="flex flex-col py-4 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('spaces.index') }}"
                            ...
                            <span class="ml-2 text-sm tracking-wide truncate">Espaces</span>
                    ...
                    <li>
                        <a href="{{ route('organizations.index') }}"
                            ...
                            <span class="ml-2 text-sm tracking-wide truncate">Organisations</span>
                            <span
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}"
                            ...
                            <button type="submit" class="ml-2 text-sm tracking-wide truncate">
                                Déconnexion
                            </button>
                        </form>
                    </li>
